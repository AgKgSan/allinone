...
import 'package:all_in_1/view/login/new_password_view.dart';
import 'package:flutter/material.dart';
import 'package:otp_pin_field/otp_pin_field.dart';

class ResetOTPView extends StatefulWidget {
  const ResetOTPView({super.key});

  @override
  State<ResetOTPView> createState() => _ResetOTPViewState();
}

class _ResetOTPViewState extends State<ResetOTPView> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Check your mobile number 09*******48 to reset your Password ",
                style: TextStyle(
